            ...
            <Layout>
                <div className="container">
                    <div className="profile">
                        <h3 className="text-uppercase ml-5 mt-3">
                            {auth.user.role === 'user' ? 'User Profile' : auth.user.role === 'admin' ? 'Admin Profile' : 'Staff Profile'}</h3>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-8 my-3 px-">
                                <div className="form-group">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input type="email" name="email" defaultValue={auth.user.email} 
                                                className="form-control" placeholder="Your email" disabled={true}/>
                                        </div>
                                <div className="form-group">
                                ...
                                <button className="btn btn-pastel" disabled={notify.loading}
                                    onClick={handleUpdateProfile}>Update
                                </button>
                            </div>
                        </div>
                    </div>
